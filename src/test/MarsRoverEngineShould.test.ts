...
describe("MarsRoverEngine ", () => {
  ...
  it.each([
    [
      [
        new InitializationCommand(new Coordinate({ x: 5, y: 5 })),
        new StartingPositionCommand(new Position(new Coordinate({x: 2, y: 2}), 'N')),
      ],
      new Position(new Coordinate({x: 2, y: 2}), 'N'),
    ],
    [
      [
        new InitializationCommand(new Coordinate({ x: 5, y: 5 })),
      ...
      new Position(new Coordinate({x: 2, y: 2}), 'W'),
    ],
    [
      [
        new InitializationCommand(new Coordinate({ x: 5, y: 5 })),
      ...
      new Position(new Coordinate({x: 2, y: 2}), 'E'),
    ],
    [
      [
        new InitializationCommand(new Coordinate({ x: 5, y: 5 })),
        new StartingPositionCommand(new Position(new Coordinate({x: 2, y: 2}), '2')),
        new MoveForwardCommand(),
      ],
      new Position(new Coordinate({x: 2, y: 3}), 'N'),
    ],
  ])(
